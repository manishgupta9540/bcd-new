...
class CreateCustomerCheckPriceShowingStatusesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customer_check_price_showing_statuses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('customer_check_price_showing_statuses');
    }
}
