   ...
   <div class="main-content">
      <div class="row">
         <div class="col-sm-11">
             ...
             <li><a href="{{ url('/app/verifications') }}">Verification</a></li>
             <li>{{$service->name}}</li>
             </ul>
         </div>
         <!-- ============Back Button ============= -->
                           ...
                           <div class="col-sm-12 ">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                       <a href="javascript:;" class="mt-3 btn btn-sm btn-primary createFormInput"> <i class="fa fa-plus"></i> Add Form Input</a></a>
                                    </div>
                                    ...
                                    <table class="table table-bordered formInputTable" id="formInputsTable">
                                          ...
                                          <tr row-id="{{$item->id}}">
                                             ...
                                             <td> 
                                                <a href="javascript:;" data-id="{{$item->id}}" class="editInput btn btn-md btn-outline-primary"><i class="far fa-edit"></i> Edit</a> 
                                             </td>
                                          </tr>
                                          @endforeach
                                          @else 
 ...
 <div class="modal" id="form_input_modal">
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <!-- Modal body -->
            <form method="post" action="{{ route('/services/form-input') }}" id="form_inputs">
            @csrf
               ...
               <p style="margin-bottom: 2px;" class="text-danger error-container" id="error-all"> </p> 
                  ...
                  <div class="form-group">
                     <label for="label_name"> Mandatory <span class="text-danger">*</span></label>
                  ...
                  <div class="form-group">
                     <label for="label_name"> Report Output (Executuve Summary) <span class="text-danger">*</span></label>
                  ...
                  <div class="form-group">
                     <label for="label_name">Report Output (Check Table) <span class="text-danger">*</span></label>
 ...
 <div class="modal"  id="edit_form_input_modal">
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <!-- Modal body -->
            <form method="post" action="{{ url('/app/services/formInput/update') }}" id="form_update">
            @csrf
               <div class="modal-body">
...
<script type="text/javascript">
   ...
   $(document).on('click','.editInput',function(){
      ...
      $.ajax({
         type: 'POST',
         url: "{{ url('/app/services/formInput/edit') }}",
      ...
      $.ajax({
         ...
         success: function (data) {
            ...
            if (data.fail == false) {
               ...
               $(".rowResult").append("<tr><td class='labelName-"+data.data.id+"'> "+data.data.label_name+" </td><td class='type-"+data.data.id+"'> "+data.data.type+" </td><td class='report_output-"+data.data.id+"'> "+report_output+" "+executive_summary+" </td><td> <a href='javascript:;' class='editInput btn btn-md btn-outline-primary' data-id='"+data.data.id+"'>Edit</a> </td></tr>"); 
            }
         },
         error: function (data) {
            console.log(data);
