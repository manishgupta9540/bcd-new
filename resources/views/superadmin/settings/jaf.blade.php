                        ...
                        <section>
                           <div class="row">
                              <div class="col-sm-2 ">
                                 ...
                                 <p class="text-muted">Required details of Personal Information</p>
                              </div>
                              <div class="col-sm-10 ">
                                 <!-- row -->
                                 <div class="row">
                                       ...
                                       <div class="row">
                                          <div class="col-sm-9 ">
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="" name="title" id="input-1" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-sm-6 ">
                                       <div class="row">
                                          <div class="col-sm-9 ">
                                             <div class="form-group">
                                                <label for="input-1"> Last name <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" value="" name="title" id="input-1" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-6 ">
                                       <div class="row">
                                          <div class="col-sm-9 ">
                                             <div class="form-group">
                                                <label for="input-1"> DOB  <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" value="" name="title" id="input-1" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="col-sm-6 ">
                                       <div class="row">
                                          <div class="col-sm-9 ">
                                             <div class="form-group">
                                                <label for="input-1"> Sex <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" value="" name="title" id="input-1" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-6 ">
                                       <div class="row">
                                          <div class="col-sm-9 ">
                                             <div class="form-group">
                                                <label for="input-1"> Nationality <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" value="" name="title" id="input-1" placeholder="">
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="col-sm-6 ">
                                       <div class="row">
                                          <div class="col-sm-9 ">
                                             <div class="form-group">
                                                <label for="input-1"> Father Name <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" value="" name="title" id="input-1" placeholder="">
                                             </div>
                                          </div>
                                       </div>
