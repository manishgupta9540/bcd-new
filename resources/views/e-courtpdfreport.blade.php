    ...
    <table cellpadding="0" cellspacing="0" class="main" style="margin-bottom: 2%">
      ...
      <tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">Name</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> Abhi Ram Sharma </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Father's Name</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> Shyam Sharma </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Address</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> D-Block, West Azad Nagar, Delhi-39 </strong></td> 
        </tr>
      ...
      <!--  -->
        ...
        <table cellpadding="0" cellspacing="0" class="main" style="padding-bottom: 2%">
            ...
            <tr>
                ...
                <h3 style="text-align: center; font-weight:400;  padding: 5px; font-size:18px; color:#333; "><b>Case - 1 </b></h3>
                </td>
            </tr>
            ...
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> 214244031382011 </strong></td> 
            </tr>
            <tr> <td style="padding:7px; border:1px solid #666; ">Details Link</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong style="color: rgb(36, 96, 105)"> https://pdf-reports-springrole.s3.amazonaws.com/governmentReport/43dde642747cafd8917e9
                bf8656dac03 </strong></td> 
            </tr>
            <tr> <td style="padding:7px; border:1px solid #666; ">Score (%)</td> 
              <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong style="color: rgb(36, 96, 105)"> 75% </strong></td> 
            </tr>
