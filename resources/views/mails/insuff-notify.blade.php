                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #FFFFFF; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                                ...
                                <tr>
                                    <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"><b>Insuff Raised By : </b>  {{$candidate->updated_by==NULL ? Helper::user_name($candidate->insuff_by) : Helper::user_name($candidate->updated_by)}} ({{Helper::company_name($candidate->cust_id)}})</p>

                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"><b>Insuff Notes : </b>  {{$candidate->notes!=NULL?$candidate->notes:'N/A'}}</p>
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"><b>Date & Time : </b>  {{$candidate->updated_at==NULL ? date('d-F-Y h:i:s a',strtotime($candidate->insuff_date)) : date('d-F-Y h:i:s a',strtotime($candidate->updated_at))}}</p>
