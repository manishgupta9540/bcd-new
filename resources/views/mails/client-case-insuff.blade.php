                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #FFFFFF; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                                ...
                                <tr>
                                    <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Here is the list of candidates who have insufficiency in checks</p>
                                                ...
                                                <table class="action" width="100%" cellpadding="0" cellspacing="0"
                                                    ...
                                                    @foreach ($candidates as $candidate)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 12px; border-bottom: 1px solid #ccc; color: #333; font-weight: bold; font-size: 13px; min-width:50px; text-align: left;">
                                                                {{Helper::getJafServiceNameSlot($jaf_id)}}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    <tr>
