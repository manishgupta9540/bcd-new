                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #FFFFFF; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                                ...
                                <tr>
                                    <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 10px; text-align: left;">{{$msg}} :- {{$candidate_name}}</p>
                                        @if ($msg == "New JAF Filling Task Created with candidate name" || $msg == "New JAF verification Task Created with candidate name" || $msg == "New JAF Batch Task Created in Batch Menu with Batch name")
                                            <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 10px; text-align: left;">Please assign to any user</p>
                                        @endif

                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"><b>Service Name : </b>
                                            @php 
                                                $count = 0; 
                                                $serve = '';
                                            @endphp 
                                            @if(count($serviceId)>0)
                                                @foreach ($serviceId as $key => $service)
                                                    @php
                                                        $service_data = Helper::get_service_all_data($service[0]);
                                                        if($service_data->verification_type=='Manual'){
                                                            $serve.= $service_data->name.' - '.$service[1]; 
                                                        }else{
                                                            $serve.= $service_data->name;
                                                        }

                                                        if(count($serviceId) != $key+1)
                                                        {
                                                            $serve.=', ';
                                                        }
                                                        $count++;
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"><b>Total Number Check : </b>  {{$count}} </p>
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"><b>Insuff By : </b>  {{Helper::user_name($candidate->insuff_by)}} ({{Helper::company_name($candidate->cust_id)}})</p>

                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"><b>Date & Time : </b>  {{date('d-F-Y h:i:s a',strtotime($candidate->insuff_date))}}</p> --}}
