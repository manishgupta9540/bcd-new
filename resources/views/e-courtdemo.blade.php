  ...
  <table cellpadding="0" cellspacing="1" class="" style="border-bottom: 1px solid rgb(145, 139, 139)">
    ...
    <table cellpadding="0" cellspacing="0" class="main" style="margin-bottom: 2%">
      ...
      <tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">Name</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$query['name']}} </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Father's Name</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$query['fatherName']}} </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Address</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$query['address']}} </strong></td> 
        </tr>
    ...
    @foreach ($reports as $key => $value)
        <table cellpadding="0" cellspacing="0" class="main" style="padding-bottom: 2%">
            ...
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$value['case_no']}} </strong></td> 
            </tr>
            <tr> <td style="padding:7px; border:1px solid #666; ">Details Link</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong style="color: rgb(36, 96, 105)"> {{$value['link']}} </strong></td> 
            </tr>
