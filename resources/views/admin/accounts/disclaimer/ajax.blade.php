    ...
    {{-- @if ($VIEW_ACCESS) --}}
        ...
        <thead class="thead-light">
            <tr>
                ...
                {{-- <th scope="col" style="position:sticky; top:60px">Enable / Disable Status</th> --}}
        ...
        <tbody>
            @if(count($items)>0)
                ...
                <?php $hide = Helper::service_control_show($item->id) ?>
                    <tr>
                        {{-- <td>{{$key+1}}</td> --}}
                        ...
                        <td>
                            ...
                            @else --}}
                                <a href="{{url('/check/input/disclaimer',['id'=>base64_encode($item->id)])}}"> <button class="btn btn-outline-info btn-md mb-1" type="button"> <i class="fa fa-edit"> </i> Edit</button> </a>
