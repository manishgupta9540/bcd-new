                                             ...
                                             @if($aadhar!=NULL || $pan!=NULL || $voter_id!=NULL || $rc!=NULL || $dl!=NULL || $passport!=NULL || $bank!=NULL || $gst!=NULL || $telecom!=NULL || $e_court!=NULL || $upi!=NULL || $cin!=NULL)
                                                @if($aadhar!=NULL)  
                                                   <tr>
                                                      ...
                                                      <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($aadhar->service_id)])}}">{{$aadhar->name}}</a></td>
                                                      <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($aadhar->service_id)])}}">{{$aadhar->no_of_hits}}</a></td>
                                                      ...
                                                      <td class="">
                                                         ...
                                                         <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($aadhar->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      {{-- <th>#</th> --}}
                                                            ...
                                                            <div class="row">
                                                               ...
                                                               <div class="col-sm-12">
                                                                  <table class="table table-bordered">
                                                                     ...
                                                                     <tbody>
                                                                        <?php $data=Helper::api_details(Auth::user()->business_id,$aadhar->service_id,'customer') ?>
                                                                        {{-- {{dd($data)}} --}}
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($pan->service_id)])}}">{{$pan->name}}</a></td>
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($pan->service_id)])}}">{{$pan->no_of_hits}}</a></td>
                                                   ...
                                                   <td class="">
                                                      ...
                                                      <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($pan->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   {{-- <th>#</th> --}}
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                               <table class="table table-bordered">
                                                                  ...
                                                                  <tbody>
                                                                     <?php $data=Helper::api_details(Auth::user()->business_id,$pan->service_id,'customer') ?>
                                                                     {{-- {{dd($data)}} --}}
                                                                     @if($data!=NULL && count($data)>0)
                                                                        @foreach ($data as $key => $d)
                                                                           <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($voter_id->service_id)])}}">{{$voter_id->name}}</a></td>
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($voter_id->service_id)])}}">{{$voter_id->no_of_hits}}</a></td>
                                                   ...
                                                   <td class="">
                                                      ...
                                                      <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($voter_id->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                   </td>   
                                                </tr> 
                                                <tr>
                                                   {{-- <th>#</th> --}}
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                               <table class="table table-bordered">
                                                                  ...
                                                                  <tbody>
                                                                     <?php $data=Helper::api_details(Auth::user()->business_id,$voter_id->service_id,'customer') ?>
                                                                     {{-- {{dd($data)}} --}}
                                                                     @if($data!=NULL && count($data)>0)
                                                                        @foreach ($data as $key => $d)
                                                                           <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($rc->service_id)])}}">{{$rc->name}}</a></td>
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($rc->service_id)])}}">{{$rc->no_of_hits}}</a></td>
                                                   ...
                                                   <td class="">
                                                      ...
                                                      <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($rc->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   {{-- <th>#</th> --}}
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                               <table class="table table-bordered">
                                                                  ...
                                                                  <tbody>
                                                                     <?php $data=Helper::api_details(Auth::user()->business_id,$rc->service_id,'customer') ?>
                                                                     {{-- {{dd($data)}} --}}
                                                                     @if($data!=NULL && count($data)>0)
                                                                        @foreach ($data as $key => $d)
                                                                           <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($dl->service_id)])}}">{{$dl->name}}</a></td>
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($dl->service_id)])}}">{{$dl->no_of_hits}}</a></td>
                                                   ...
                                                   <td class="">
                                                      ...
                                                      <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($dl->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   {{-- <th>#</th> --}}
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                               <table class="table table-bordered">
                                                                  ...
                                                                  <tbody>
                                                                     <?php $data=Helper::api_details(Auth::user()->business_id,$dl->service_id,'customer') ?>
                                                                     {{-- {{dd($data)}} --}}
                                                                     @if($data!=NULL && count($data)>0)
                                                                        @foreach ($data as $key => $d)
                                                                           <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($passport->service_id)])}}">{{$passport->name}}</a></td>
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($passport->service_id)])}}">{{$passport->no_of_hits}}</a></td>
                                                   ...
                                                   <td class="">
                                                      ...
                                                      <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($passport->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   {{-- <th>#</th> --}}
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                               <table class="table table-bordered">
                                                                  ...
                                                                  <tbody>
                                                                     <?php $data=Helper::api_details(Auth::user()->business_id,$passport->service_id,'customer') ?>
                                                                     {{-- {{dd($data)}} --}}
                                                                     @if($data!=NULL && count($data)>0)
                                                                        @foreach ($data as $key => $d)
                                                                           <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($bank->service_id)])}}">{{$bank->name}}</a></td>
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($bank->service_id)])}}">{{$bank->no_of_hits}}</a></td>
                                                   ...
                                                   <td class="">
                                                      ...
                                                      <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($bank->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   {{-- <th>#</th> --}}
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                               <table class="table table-bordered">
                                                                  ...
                                                                  <tbody>
                                                                     <?php $data=Helper::api_details(Auth::user()->business_id,$bank->service_id,'customer') ?>
                                                                     {{-- {{dd($data)}} --}}
                                                                     @if($data!=NULL && count($data)>0)
                                                                        @foreach ($data as $key => $d)
                                                                           <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($gst->service_id)])}}">{{$gst->name}}</a></td>
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($gst->service_id)])}}">{{$gst->no_of_hits}}</a></td>
                                                   ...
                                                   <td class="">
                                                      ...
                                                      <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($gst->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   {{-- <th>#</th> --}}
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                               <table class="table table-bordered">
                                                                  ...
                                                                  <tbody>
                                                                     <?php $data=Helper::api_details(Auth::user()->business_id,$gst->service_id,'customer') ?>
                                                                     {{-- {{dd($data)}} --}}
                                                                     @if($data!=NULL && count($data)>0)
                                                                        @foreach ($data as $key => $d)
                                                                           <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($telecom->service_id)])}}">{{$telecom->name}}</a></td>
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($telecom->service_id)])}}">{{$telecom->no_of_hits}}</a></td>
                                                   ...
                                                   <td class="">
                                                      ...
                                                      <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($telecom->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   {{-- <th>#</th> --}}
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                               <table class="table table-bordered">
                                                                  ...
                                                                  <tbody>
                                                                     <?php $data=Helper::api_details(Auth::user()->business_id,$telecom->service_id,'customer') ?>
                                                                     {{-- {{dd($data)}} --}}
                                                                     @if($data!=NULL && count($data)>0)
                                                                        @foreach ($data as $key => $d)
                                                                           <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($e_court->service_id)])}}">{{$e_court->name}}</a></td>
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($e_court->service_id)])}}">{{$e_court->no_of_hits}}</a></td>
                                                   ...
                                                   <td class="">
                                                      ...
                                                      <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($e_court->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   {{-- <th>#</th> --}}
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                               <table class="table table-bordered">
                                                                  ...
                                                                  <tbody>
                                                                     <?php $data=Helper::api_details(Auth::user()->business_id,$e_court->service_id,'customer') ?>
                                                                     {{-- {{dd($data)}} --}}
                                                                     @if($data!=NULL && count($data)>0)
                                                                        @foreach ($data as $key => $d)
                                                                           <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($upi->service_id)])}}">{{$upi->name}}</a></td>
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($upi->service_id)])}}">{{$upi->no_of_hits}}</a></td>
                                                   ...
                                                   <td class="">
                                                      ...
                                                      <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($upi->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   {{-- <th>#</th> --}}
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                               <table class="table table-bordered">
                                                                  ...
                                                                  <tbody>
                                                                     <?php $data=Helper::api_details(Auth::user()->business_id,$upi->service_id,'customer') ?>
                                                                     {{-- {{dd($data)}} --}}
                                                                     @if($data!=NULL && count($data)>0)
                                                                        @foreach ($data as $key => $d)
                                                                           <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($cin->service_id)])}}">{{$cin->name}}</a></td>
                                                   <td><a class="text-info btn-lnk" href="{{url('/api-usage/details',['id'=>base64_encode($cin->service_id)])}}">{{$cin->no_of_hits}}</a></td>
                                                   ...
                                                   <td class="">
                                                      ...
                                                      <span><a class="btn btn-outline-dark" href="{{url('/api-usage/details',['id'=>base64_encode($cin->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   {{-- <th>#</th> --}}
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                               <table class="table table-bordered">
                                                                  ...
                                                                  <tbody>
                                                                     <?php $data=Helper::api_details(Auth::user()->business_id,$cin->service_id,'customer') ?>
                                                                     {{-- {{dd($data)}} --}}
                                                                     @if($data!=NULL && count($data)>0)
                                                                        @foreach ($data as $key => $d)
                                                                           <tr>
...
<div class="modal" id="download_api">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <!-- Modal body -->
         <form method="post" action="{{url('/api-usage/download')}}" id="downloadapiFrm">
         @csrf
