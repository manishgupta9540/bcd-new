            ...
            <div class="formCover" style="height: 100vh; background:#fff">
               <!-- section -->
                  <div class="col-sm-12 ">
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="card-title mb-1 mt-3">Create FAQ </h4>
                            {{-- <p class="pb-border"> Create the FAQ.  </p> --}}
                        </div>
                        <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="question" class="form-control question @error('question') is-invalid @enderror" name="question" placeholder="e.g. Question">
                                                            @error('question')
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="answer" class="form-control answer " name="answer" placeholder="e.g. Answer"></textarea>
