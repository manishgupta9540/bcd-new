                     ...
                     <div class="formCover py-2" style="height: 100vh;">
                        ...
                        <section>
                           ...
                           <div class="col-sm-12 ">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <h4 class="card-title mb-1 mt-3">Customer Wise</h4>
                                       <p class="pb-border"></p>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 pt-3">
                                       <div id="candidatesResult">
                                          @include('admin.accounts.verifications.ajax')        
                                       </div>
                                    </div>
                                 </div>
                                 <!-- ./business detail -->
...
<script>
   $(document).ready(function() {
    ...
    $(document).on('click', '.hold', function (event) {
        ...
        $.ajax({
            type:'GET',
            url: "{{route('/verification/customer_wise/hide')}}",
    ...
    $(document).on('click', '.resume', function (event) {
        ...
        if(confirm("Are you sure want to Show verification of this COC ?")){
        $.ajax({
            type:'GET',
            url: "{{route('/verification/customer_wise/show')}}",
            data: {'customer_id':customer_id},        
            success: function (response) {        
            console.log(response);
