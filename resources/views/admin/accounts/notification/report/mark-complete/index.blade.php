                           ...
                           <div class="col-sm-12 ">
                                 ...
                                 <div class="row">
                                    <div class="col-md-9">
                                       ...
                                       <span>
                                          Note:- Enable the customer to send the mail at the time of report completion when we select “Report mark as completed” to the report edit module (Enter the email address via edit button to which you want to send the mail).
                                       </span>
                                       <p class="pb-border"></p>
                                    </div>
                           ...
                           <div class="row">
                            <div class="col-md-12 pt-3">
                                <div id="candidatesResult">
                                    @include('admin.accounts.notification.report.mark-complete.ajax')        
                                 </div>
                            </div>
                         </div>
                        </section>
...
<div class="modal" id="notify_modal">
    <div class="modal-dialog modal-lg">
       <div class="modal-content">
          ...
          <!-- Modal body -->
          <form method="post" action="{{url('/notification/report/mark-complete/edit')}}" id="notify_frm" enctype="multipart/form-data">
          @csrf
...
<script>
    $(document).ready(function() {
         ...
         swal({
            ...
            function(e){
               if(e==true)
               {
                      $.ajax({
                           type:'POST',
                           url: "{{ url('/')}}"+"/notification/report/mark-complete/status",
      ...
      $(document).on('click', '.editBtn', function (event) {
            ...
            $.ajax({
               type: 'GET',
               url: "{{ url('/notification/report/mark-complete/edit') }}",
               data: {'id':id},        
            ...
            swal({
               ...
               function(e){
                  if(e==true)
                  {
                     $.ajax({
                           type:'POST',
                           url: "{{route('/notification/report/mark-complete/delete')}}",
