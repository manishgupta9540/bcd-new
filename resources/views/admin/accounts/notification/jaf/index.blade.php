            ...
            <div class="modal-body">
               <div class="row">
                  ...
                  <div class="col-12">
                     ...
                     <p class="pb-border"></p>
                     <div class="col-6">
                        <label for="label_name" class="cust_lbl"> Reminder Count : </label>
                        <input type="number" min="1" name="reminder_count" class="form-control reminder_count">
                     </div>
                     <p class="pb-border"></p>
            ...
            $.ajax({
               ...
               success: function (data) {
                  ...
                  { 
                        ...
                        $('.reminder_count').val(data.reminder);
