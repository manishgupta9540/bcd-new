                  ...
                  <div class="col-md-9 content-wrapper" style="background:#fff">
                     <div class="formCover" style="height: 100vh;">
                        ...
                        <section>
                           ...
                           @include('admin.accounts.notification.insufficiency.menu')
                           <div class="col-sm-12 ">
                                 <!-- row -->
                                 <div class="row">
                                    <div class="col-md-9">
                                       ...
                                       <span>
                                          Note:- Enable that customer to send the mail on every 24 hours if insufficiency has not been cleared. (Enter the email address via edit button to which you want to send the mail).
                                       </span>
                                       <p class="pb-border"></p>
                                    </div>
                           ...
                           <div class="row">
                            <div class="col-md-12 pt-3">
                                <div id="candidatesResult">
                                    @include('admin.accounts.notification.insufficiency.ajax')        
                                 </div>
                            </div>
                         </div>
                        </section>
...
<div class="modal" id="notify_modal">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <!-- Modal body -->
         <form method="post" action="{{url('/notification/insuff/default/edit')}}" id="notify_frm" enctype="multipart/form-data">
         @csrf
...
<script>
    $(document).ready(function() {
         ...
         swal({
            ...
            function(e){
               if(e==true)
               {
                      $.ajax({
                           type:'POST',
                           url: "{{ url('/')}}"+"/notification/insuff/default/status",
      ...
      $(document).on('click', '.editBtn', function (event) {
            ...
            $.ajax({
               type: 'GET',
               url: "{{ url('/notification/insuff/default/edit') }}",
               data: {'id':id},        
            ...
            swal({
               ...
               function(e){
                  if(e==true)
                  {
                     $.ajax({
                           type:'POST',
                           url: "{{route('/notification/insuff/default/delete')}}",
