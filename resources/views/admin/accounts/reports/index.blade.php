                     ...
                     <div class="formCover py-2" style="height: 100vh;">
                        ...
                        <section>
                           ...
                           <div class="col-sm-12 ">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <h4 class="card-title mb-1 mt-3">Report Template 2</h4>
                                       <p class="pb-border">Note :- If we enable template-2, an executive summary will be added in the report.</p>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 pt-3">
                                       <div id="candidatesResult">
                                          @include('admin.accounts.reports.ajax')        
                                       </div>
                                    </div>
                                 </div>
                                 <!-- ./business detail -->
      ...
      <div class="modal-content">
         ...
         <!-- Modal body -->
            <div class="modal-body">
               ...
               <iframe 
                   src="{{url('/').'/report_template/template2.pdf/'}}" 
...
<script>
   ...
   $(document).ready(function() {
    ...
    $(document).on('click', '.hold', function (event) {
        ...
        $.ajax({
            type:'GET',
            url: "{{url('/reports/customer_wise/disable')}}",
    ...
    $(document).on('click', '.resume', function (event) {
        ...
        $.ajax({
            type:'GET',
            url: "{{url('/reports/customer_wise/enable')}}",
            data: {'customer_id':customer_id},        
            success: function (response) {        
            console.log(response);
