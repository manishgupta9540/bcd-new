                     ...
                     <div class="formCover py-2" style="height: 100vh;">
                        ...
                        <section>
                           ...
                           <div class="col-sm-12 ">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <h4 class="card-title mb-1 mt-3">Report Custom Revised Date </h4>
                                       <p class="pb-border">Note :- If we enable, this feature a revised date field will be added in the report to add custom revised date.</p>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 pt-3">
                                       <div id="candidatesResult">
                                          @include('admin.accounts.reports.custom-ajax')        
                                       </div>
                                    </div>
                                 </div>
                                 <!-- ./business detail -->
