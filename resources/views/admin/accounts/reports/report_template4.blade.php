            ...
            <div class="formCover py-2" style="height: 100vh;">
               ...
               <section>
                  ...
                  <div class="col-sm-12 ">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <h4 class="card-title mb-1 mt-3">Report Template 4 </h4>
                              <p class="pb-border">Note :- If we enable template-4, an executive summary will be updated in the report.</p>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-md-12 pt-3">
                              <div id="candidatesResult">
                                 @include('admin.accounts.reports.report_template4-ajax')        
                              </div>
                           </div>
                        </div>
                        <!-- ./business detail -->
      ...
      <div class="modal-content">
         ...
         <!-- Modal body -->
            <div class="modal-body">
               ...
               <iframe 
                   src="{{url('/').'/report_template/template_report4.pdf'}}" 
   ...
   $(document).ready(function() {
    ...
    $(document).on('click', '.hold', function (event) {
        ...
        if(confirm("Are you sure want to Disable Custom PDF page of this COC ?")){
         $.ajax({
               type:'GET',
               url: "{{url('/reports/template4/report/disable')}}",
    ...
    $(document).on('click', '.resume', function (event) {
        ...
        if(confirm("Are you sure want to Enable Custom PDF page of this COC ?")){
         $.ajax({
               type:'GET',
               url: "{{url('/reports/template4/report/enable')}}",
               data: {'customer_id':customer_id},        
               success: function (response) {        
               console.log(response);
