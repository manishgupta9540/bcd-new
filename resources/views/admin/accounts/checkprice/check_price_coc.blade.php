                           ...
                           <div class="col-sm-12 ">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6 mt-3 text-right">
                                       ...
                                       {{-- <a href="" class="mt-3 btn btn-sm btn-info">Payment Method</a> --}}
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 pt-3">
                                       <div id="candidatesResult">
                                          @include('admin.accounts.checkprice.check_price_coc_ajax')        
                                       </div>
                                    </div>
                                 </div>
                                 <!-- ./business detail -->
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-header">
            <h4 class="modal-title">Add Customer Price</h4>
            <button type="button" class="close" style="top: 12px;!important; color: red;" data-dismiss="modal"><small>×</small></button>
         </div>
         <!-- Modal body -->
         <form method="post" action="{{url('/checkprice/customer_wise/store')}}" id="checkpriceadd">
         @csrf
            <div class="modal-body">
            <div class="form-group">
               <label for="label_name"> Customer Name : <span class="text-danger">*</span></label>
              ...
              <p style="margin-bottom: 2px;" class="text-danger error-container" id="error-customer"></p> 
            </div>
            <div class="form-group">
