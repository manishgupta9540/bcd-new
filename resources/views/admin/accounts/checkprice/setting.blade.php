                     ...
                     <div class="formCover py-2" style="height: 100vh;">
                        ...
                        <section>
                           ...
                           <div class="col-sm-12 ">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <h4 class="card-title mb-1 mt-3">Setting</h4>
                                       <p class="pb-border"></p>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 pt-3">
                                       <div id="candidatesResult">
                                          @include('admin.accounts.checkprice.setting_ajax')        
                                       </div>
                                    </div>
                                 </div>
                                 <!-- ./business detail -->
...
<script>
   $(document).ready(function() {
    ...
    $(document).on('click', '.hold', function (event) {
        ...
        if(confirm("Are you sure you want to change the Status of this COC ?")){
        $.ajax({
            type:'GET',
            url: "{{route('/checkprice/hide')}}",
