                  ...
                  <div class="col-md-9 content-wrapper" style="background:#fff">
                     <div class="formCover py-2" style="height: 100vh;">
                        ...
                        <section>
                           ...
                           @include('admin.accounts.jafcontrollink.menu')
                           <div class="col-sm-12 ">
                                 <!-- row -->
                                 <div class="row">
                                    <div class="col-md-6">
                                       <h4 class="card-title mb-1 mt-3">Jaf Video Links </h4>
                                       <p class="pb-border"></p>
                                    </div>
                                    <div class="col-md-6 mt-3 text-right">
                                       <div class="btn-group" style="float:right">     
                                          <a href="#" class="filter0search"><i class="fa fa-filter"></i></a>
                                          <span><a class="btn btn-success add_new_jaf_link_btn" href="#" > <i class="fa fa-plus"></i> Add New Link</a></span> 
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 pt-3">
                                       <div id="candidatesResult">
                                          @include('admin.accounts.jafcontrollink.ajax')        
                                       </div>
                                    </div>
                                 </div>
                           </div>
...
<div class="modal" id="add_jaf_link">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <!-- Modal body -->
         <form method="post" action="{{url('settings/jafvideolink/store')}}" id="send_link">
         @csrf
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="video_jaf_links" name="video_jaf_links" class="form-control jaf_links" placeholder="Enter jaf Links"/>
                    <p style="margin-bottom: 2px;" class="text-danger error-container error-video_jaf_links" id="error-jaf_links"></p> 
                </div>
            </div>
            <!-- Modal footer -->
...
<script>
   $(document).ready(function() {
      ...
      //modal show add new send link
        $('.add_new_jaf_link_btn').click(function(){
            $("#send_link")[0].reset();
    ...
    $(document).on('click', '.status', function (event) {
         ...
         $.ajax({
               type:'POST',
               url: "{{ url('/')}}"+"/jaf/video/links/status",
