                        ...
                        <table class="table table-bordered ">
                           ...
                           <tbody class="contactList">
                              ...
                              <tr>
                                 ...
                                 <td> {{$item->email}} </td>
                                 <td> {{$item->phone}} </td>
                                 <td> {{ Helper::get_user_fullname($item->contact_owner) }} </td>
...
<div class="" id="formSidebar">
   ...
   <form action="{{ route('/contacts/store') }}" method="post" id="addContactForm">
   @csrf
      ...
      <div class="form-group">
         ...
         <select class="form-control" id="lifecycle-stage" name="lifecycle_stage">
      ...
      <div class="form-group">
         ...
         <select class="form-control" id="lead-staus" name="lead_status">
...
#formSidebar>form{overflow:auto; height:68vh;padding:10px 20px; clear:both; }
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if(response.success==true  ) {          
               ...
               $("tbody.contactList").prepend("<tr><td scope='row'><input type='checkbox'></td><td><a href=''>"+response.data.name+"</a></td><td> "+response.data.email+"</td><td>"+response.data.phone+"</td><td>"+response.data.f_name+" "+response.data.l_name+"</td><td>"+response.data.associated_company+"</td></tr>");
