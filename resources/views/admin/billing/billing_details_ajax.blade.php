        ...
        {{-- <div class="table-responsive"> --}}
            <table class="table table-bordered">
                <thead class="thead-light">
                    <tr>
                        <th class="text-center" scope="col" width="5%" style="position:sticky; top:60px">#</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <a href="{{route('/candidates/show',['id'=>base64_encode($c_item->candidate_id)])}}">
                                            {{Helper::candidate_user_name($c_item->candidate_id)}}<br>
                                        </a>
                                        <small class="text-muted">Ref. No. <b>{{Helper::candidate_reference_id($c_item->candidate_id)}}</b></small>
                                    </td>
                                    <td>
                                        <?php 
