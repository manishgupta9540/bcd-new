    ...
    <!--  -->
      <tr>
        ...
        <tr> <td style="padding:7px; border: 1px solid #666; ">DL Number</td> 
          <td  class="voter_number" style="padding:7px; border: 1px solid #666; "><b> {{ $data->dl_number}}</b></td> 
        </tr>
        
         <tr> <td style="padding:7px; border: 1px solid #666; ">Name</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $data->name}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Gender</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $data->gender}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">DOB</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ date('d-m-Y', strtotime($data->dob))}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Father / Spouse Name</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $data->father_or_husband_name}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Address</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $data->permanent_address}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">State</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $data->state}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Country</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $data->citizenship}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">DTO</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $data->ola_name}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Date Of Expire</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ date('d-m-Y', strtotime($data->doe))}} </strong></td> 
         </tr>
      </tr>
      <!--  -->
    </table>
