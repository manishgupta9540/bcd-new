                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <h3 class="card-title mb-3"> Import Candidates </h3> 
                                    ...
                                    <div class="uploader">
                                    <div class="col-md-8">
                                    <form method="post" enctype="multipart/form-data" action="{{ url('/candidates/import') }}">
                                        @csrf
                                        ...
                                        <input class="form-control" type="file" id="csv_file" name="excelFile">
