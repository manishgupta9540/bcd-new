                            ...
                            @if( count($report_items) > 0 )
                                ...
                                @foreach($report_items as $r_key => $item)
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:5px; border:1px solid #666;background:#ccc; text-align:center;"><strong> {{$item->service_name.' Check'.' - '. $check_no }}</strong></td>
                                        <td style="padding:5px; border:1px solid #666; text-align:center;"> 
                                            ...
                                            @elseif(stripos($item->type_name,'drug_test_10')!==false)
                                                10 Panel
                                            @elseif(stripos($item->type_name,'criminal')!==false)
                                                Civil And Criminal
                                            @else
                                                {!! $particular !!}
                                            @endif
                                        ...
                                        <td style="padding:5px; border:1px solid #666;color:darkgreen; text-align:center;"> 
                                            {{$item->annexure_value}}
                                        </td>
                                    </tr>
                                    <?php $r_item_id = $item->id;?>
