...
<div class="main-content-wrap sidenav-open d-flex flex-column">
   ...
   <div class="main-content">
     ...
     <?php $user_type = Auth::user()->user_type;
           ...
           //passing action title and route group name   
      ?>
      <div class="row"> 
         {{-- <div class="col-md-12"> --}}
            ...
            <div class="card-body">
               <div class="row">
                  ...
                  @endif
                     ...
                     $VENDOR_TASK_ACCESS    = Helper::can_access('Vendor Task','');
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      // filterBtn
      $(document).on('change','.from_date, .to_date, .candidate_list,.sla_list,.user_list,.ref_list,#rows,#service,#task_type,#assign_status,#complete_status,#ref', function (e){    
         $("#overlay").fadeIn(300);　
         getData(0);
         e.preventDefault();
      });
...
// });
   ...
   function getData(page){
      ...
      //   var report_status=$('.report_status').val();               
         ...
         $.ajax(
         {
               url: '?page=' + page+'&customer_id='+user_id+'&from_date='+from_date+'&to_date='+to_date+'&candidate_id='+candidate_id+'&sla_id='+sla_id+'&user_id='+cus_user_id+'&rows='+rows+'&service_id='+service_id+'&task_type='+task_type+'&assign_status='+assign_status+'&complete_status='+complete_status+'&ref='+ref,
               type: "get",
               datatype: "html",
         })
         .done(function(data)
   ...
   function setData(){
      ...
      // var report_status=$('.report_status').val();
            $.ajax(
            {
               url: "{{ url('/') }}"+'/candidates/setData/?customer_id='+user_id+'&from_date='+from_date+'&to_date='+to_date+'&candidate_id='+candidate_id+'&sla_id='+sla_id+'&user_id='+cus_user_id+'&rows='+rows+'&service_id='+service_id+'&task_type='+task_type+'&assign_status='+assign_status+'&complete_status='+complete_status+'&ref='+ref,
               type: "get",
               datatype: "html",
            })
            .done(function(data)
   ...
   $(document).on('click','#previewImgBtn',function(e){ 
      e.preventDefault();
      var _this = $(this);
   ...
   $(document).on('click','.remove-image',function(){ 
      ...
      swal({
         icon: "warning",
               ...
               // closeOnCancel: false,
               buttons : {
                        confirm : { text: "Yes", className: "btn-success"},
                        cancel : "Cancel"
                    }
         }).
         then((e)=>{
