...
<div class="modal"  id="send_otp_covid">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <!-- Modal body -->
         <form method="post" action="{{ url('/guest/idCovid19Check/covid19') }}" id="covid19_check">
         @csrf
...
<div class="modal" id="covid19_ref">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <!-- Modal body -->
         <form method="post" action="{{ url('/guest/idCovid19Check/covid19ref') }}" id="covid19_ref_check">
         @csrf
