...
<html>
  ...
  <div class="cover" >
    ...
    <table cellpadding="0" cellspacing="0" class="main" style="margin-bottom: 2%">
      ...
      <tr> 
        <td width="50%" style="padding:7px; border:1px solid #666; ">Court Check V1 Validity</td> 
       ...
       <tr> <td style="padding:7px; border:1px solid #666; ">Name</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$name}} </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Father's Name</td> 
        <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$father_name}} </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Address</td> 
        <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$address}} </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Type</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$type}} </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">State</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$state}} </strong></td> 
        </tr>
