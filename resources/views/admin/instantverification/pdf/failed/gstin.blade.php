    ...
    <!--  -->
      <tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">GSTIN Number</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{ $gstin_number }} </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Filling Record Needed?</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{ $filling_status }} </strong></td> 
        </tr>
