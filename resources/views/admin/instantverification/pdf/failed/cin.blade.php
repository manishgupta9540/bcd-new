...
<html>
  ...
  <div class="cover" >
    ...
    <table cellpadding="0" cellspacing="0" class="main" style="margin-bottom: 2%">
      ...
      <tr> 
        <td width="50%" style="padding:7px; border:1px solid #666; ">CIN Validity</td> 
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">CIN Number</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$cin_number}} </strong></td> 
        </tr>
