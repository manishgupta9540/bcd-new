    ...
    <!--  -->
      <tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">Pan Validity</td> 
         <td class='pan_validity' style="padding:7px; border:1px solid #666; ">Invalid <img style='width:30px; margin-bottom:-7px;' src="{{ asset('admin/images/check-cancel_50x50.png') }}" alt=""></td> 
        </tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">Pan Number</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{ $pan_number }} </strong></td> 
        </tr>
      <!--  -->
    </table>
