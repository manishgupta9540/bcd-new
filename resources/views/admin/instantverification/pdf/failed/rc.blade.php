    ...
    <!--  -->
      <tr>
        <td colspan="2" style="padding: 5px; text-align:center ">
         ...
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong>Invalid</strong> <img style='width:30px; margin-bottom:-10px;' src="{{ asset('admin/images/check-cancel_50x50.png') }}" alt=""></td> 
        </tr>
        ...
        <tr> <td width="50%" style="padding:7px; border:1px solid #666; ">RC Number</td> 
          <td width="50%" class="rc_number" style="padding:7px; border:1px solid #666; "> <strong>{{ $rc_number}}</strong> </td> 
        </tr>
