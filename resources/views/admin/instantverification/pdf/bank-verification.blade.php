    ...
    <!--  -->
      <tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">Bank Account Number</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{ $master_data->account_number }} </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">IFSC Code</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{ $master_data->ifsc_code }} </strong></td> 
        </tr>
