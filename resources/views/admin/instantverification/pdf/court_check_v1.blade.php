...
<html>
    ...
    <htmlpagefooter name="page-footer">
        <footer>
          <p style="font-size:13px;border-top:1px solid #666;padding-top:20px;">
            ...
            {{-- <br><b>Techsaga Corporations</b><br> --}}
            <b>Website Link:-</b> <a href="https://premier-consultancy.com/">https://premier-consultancy.com/</a></p>
            {{-- <b>Website Link:-</b> <a href="https://www.techsaga.co.in/">https://www.techsaga.co.in/</a></p> --}}
  ...
  <div class="cover" >
    ...
    <table cellpadding="0" cellspacing="0" class="main" style="margin-bottom: 2%">
      ...
      <tr>
        <td colspan="2" style="padding: 5; text-align:center ">
          <h3 style="text-align: center; font-weight:400;  padding: 5px; font-size:18px; color:#333; "><b>Court Check V1 Verification </b></h3>
        </td>
      </tr>
      
        <tr> <td style="padding:7px; border:1px solid #666; width:30%">Court Check V1 Validity</td> 
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">Type</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{$master_data->type}} </strong></td> 
        </tr>
    ...
    <?php
        $cases = json_decode($master_data->cases,true);

        $count = $cases!=''&& $cases!=NULL ? count($cases) : 0;
    ?>
    @if($count > 0)
        @foreach ($cases as $key => $value)
            <table cellpadding="0" cellspacing="0" class="main" style="padding-bottom: 2%">
                ...
                <tr> <td style="padding:7px; border:1px solid #666;width:30%; ">Name as per court record</td> 
                    <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{array_key_exists('name',$value) ? $value['name'] : ''}} </strong></td> 
                </tr>
                <tr> <td style="padding:7px; border:1px solid #666; ">Case Number</td> 
                    <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{array_key_exists('caseNumber',$value) ? $value['caseNumber'] : ''}} </strong></td> 
                </tr>
                <tr> <td style="padding:7px; border:1px solid #666; ">CNR</td> 
                <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong style="color: rgb(36, 96, 105)"> {{array_key_exists('cnr',$value) ? $value['cnr'] : ''}} </strong></td> 
                </tr>
                <tr> <td style="padding:7px; border:1px solid #666; ">Score (%)</td> 
                  <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong style="color: rgb(36, 96, 105)"> {{array_key_exists('score',$value) ? $value['score'] : ''}} </strong></td> 
                </tr>
                <tr> <td style="padding:7px; border:1px solid #666; ">Address</td> 
                    <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong style="color: rgb(36, 96, 105)"> {{array_key_exists('address',$value) ? $value['address'] : ''}} </strong></td> 
                </tr>
                <tr> <td style="padding:7px; border:1px solid #666; ">Address State</td> 
                    <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong style="color: rgb(36, 96, 105)"> {{array_key_exists('addressState',$value) ? $value['addressState'] : ''}} </strong></td> 
                </tr>
                <tr> <td style="padding:7px; border:1px solid #666; ">State</td> 
                    <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong style="color: rgb(36, 96, 105)"> {{array_key_exists('stateName',$value) ? $value['stateName'] : ''}} </strong></td> 
                </tr>
                <tr> <td style="padding:7px; border:1px solid #666; ">District</td> 
                    <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong style="color: rgb(36, 96, 105)"> {{array_key_exists('districtName',$value) ? $value['districtName'] : ''}} </strong></td> 
                </tr>
