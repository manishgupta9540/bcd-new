                     ...
                     <section>
                        <div class="col-sm-12 ">
                           ...
                           @endif
                            ...
                            <div class="row">
                                 <div class="col-md-12">
                                    <h4 class="card-title mb-1 mt-3">Check Price <small class="text-muted"> ( {{ Helper::user_name($profile->user_id)  }} - {{  $profile->company_name!=null?$profile->company_name: 'Individual' }}) </small></h4>
                                    <p class="pb-border"> Create the new Check Price  </p>
                                 </div>
                                <div class="col-md-12">
                                    <form method="post" action="{{ url('/admin/vendor/checkPrice/update') }}" id="createSLAForm">
                                        @csrf
                                        <input type="hidden" name="vendor" value="{{ $profile->id }}" class="vendor">
                                        <input type="hidden" name="service_item_id" value="{{base64_encode($service_item->id) }}" class="service_item_id">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="services" class="form-control" id="services" placeholder="services" value=" {{ Helper::get_service_name($service_item->service_id) }}" readonly>

                                                    {{-- <select class="form-control services" name="services">
                                                        <option value="">Select Service</option>
                                                        @foreach($services as $service) 
                                                        <option value="{{ $service->id }}" @if ($service->id==$service_item->service_id) selected  @endif  >{{ $service->name }}</option>
                                                        @endforeach
                                                    </select> --}}
                                            ...
                                            <div class="col-sm-6">
                                                <div class="check_price ">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="price" class="form-control" id="price" placeholder="price" value="{{ $service_item->price}}">
      ...
      $.ajax({
         ...
         success: function (response) {
               ...
               if(response.success==true) {          
                  ...
                  toastr.success('Check price has been updated Successfully');
                  window.setTimeout(function(){
