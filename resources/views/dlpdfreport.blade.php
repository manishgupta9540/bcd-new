    ...
    <!--  -->
      <tr>
        ...
        <tr> <td style="padding:7px; border: 1px solid #666; ">DL Number</td> 
          <td  class="voter_number" style="padding:7px; border: 1px solid #666; "><b> DL0520180307301</b></td> 
        </tr>
        
         <tr> <td style="padding:7px; border: 1px solid #666; ">Name</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> AMIT KUMAR </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Gender</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> Male </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">DOB</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> 20-04-1994 </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Spouse Name</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> GIRISH KUMAR </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Address</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> R-38 GALI NO- 10 V- BLOCK NAND PARK,DELHI </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">State</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> DL </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Country</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> IND </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">DTO</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> DY.DIR.ZONAL OFFICE,DELHI SOUTH EAST, VIKAS ROAD </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Date Of Expire</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> 15-09-2036 </strong></td> 
         </tr>
      </tr>
      <!--  -->
    </table>
