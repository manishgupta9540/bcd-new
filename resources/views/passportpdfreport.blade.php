    ...
    <!--  -->
      <tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">Passport Number</td> 
         <td class='' style="padding:7px; border:1px solid #666; "><strong> Y5094321 </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Name</td> 
         <td class='' style="padding:7px; border:1px solid #666; "><strong> MANISH GAUTAM </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">DOB</td> 
              <td class='' style="padding:7px; border:1px solid #666; "><strong> 18-03-1995 </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">File No.</td> 
             <td class='' style="padding:7px; border:1px solid #666; "><strong> TP8063370822374 </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Date Of Application</td> 
            <td class='' style="padding:7px; border:1px solid #666; "><strong> 19-08-2019 </strong></td> 
        </tr>
