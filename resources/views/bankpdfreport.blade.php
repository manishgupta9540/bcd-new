    ...
    <!--  -->
      <tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">Name</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> AMIT SAH </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Bank Account Number</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> 164001502832 </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">IFSC Code</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> IDBI0005870 </strong></td> 
        </tr>
