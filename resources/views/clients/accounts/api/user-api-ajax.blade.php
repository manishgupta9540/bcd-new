          ...
          @if(count($items) > 0)
             @foreach ($items as $item)
                <tr>
                   ...
                   <td><a class="text-info btn-lnk" href="{{url('/my/api-usage/details',['id'=>base64_encode($item->service_id)])}}">{{$item->name}}</a></td>
                   <td><a class="text-info btn-lnk" href="{{url('/my/api-usage/details',['id'=>base64_encode($item->service_id)])}}">{{$item->no_of_hits}}</a></td>
                   ...
                   <td class="">
                      ...
                      <span><a class="btn btn-outline-dark" href="{{url('/my/api-usage/details',['id'=>base64_encode($item->service_id)])}}" title="Preview Details"><i class="far fa-eye"></i></a></span>
                   </td>
                </tr>
                <tr>
                   {{-- <th>#</th> --}}
                         ...
                         <div class="row">
                            ...
                            <div class="col-sm-12">
                               <table class="table table-bordered">
                                  ...
                                  <tbody>
                                     <?php $data=Helper::api_details(Auth::user()->business_id,$item->service_id,'coc') ?>
                                     {{-- {{dd($data)}} --}}
