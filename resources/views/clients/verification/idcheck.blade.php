   ...
   $(document).on('click', '.accept', function (event) {
            ...
            $.ajax({
               ...
               success:function(data)
               {
                  ...
                  if(data.fail == false)
                  {
                     ...
                     $('#cinReportExport').attr('href',"/my/IDcheck/cin/pdf/"+data.data.id);
      ...
      $(document).on('click',"#court_check_v1",function() {
         ...
         if(inputData !="" && finalInputID.length >= 3 && inputDataType!=''){
            //
            $.ajax({
               url:"{{ route('/my/idCheck/court_check_v1') }}",
               method:"POST",
               ...
               success:function(data)
               {
                  ...
                  if(data.fail == false)
                  {
                     ...
                     $('#courtv1ReportExport').attr('href',"/my/IDcheck/court_check_v1/pdf/"+data.data.id);
