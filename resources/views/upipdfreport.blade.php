    ...
    <table cellpadding="0" cellspacing="0" class="main" style="margin-bottom: 2%">
      ...
      <tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">UPI ID</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> ishansingh43@ybl </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Name</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> ISHAN SINGH S O AMIT SINGH </strong></td> 
        </tr>
