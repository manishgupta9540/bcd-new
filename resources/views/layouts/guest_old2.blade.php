<html lang="{{ app()->getLocale() }}">
   <head>
    ...
    <link href="{{ asset('guest/css/style.css?ver=2.1')}}" rel="stylesheet" />
    ...
    margin-top: 100px;
        ...
        @media(max-width:650px){
            /* .main-content-wrap {
             ...
             .layout-sidebar-large .main-header .header-part-right{ width: 75%;}
             .submit .submit_btn{ float: left !important; width: 40% !important;}
   ...
   <body class="text-left">
      <div class="app-admin-wrap layout-sidebar-large">
            <div class="main-header desktop-header md-none">
                ...
                <div class="d-flex align-items-center">
                    <h3 class="card-title mb-3">
                         <a href="{{env('APP_INSTANT')}}">
                           <img style='height:45px; object-fit:contain; width:150px;' src="{{asset('admin/images/BCD-Logo3.png')}}" class="logo" alt='BCD'>
                       </a> 
                    </h3>
                </div>
                <div style="margin: auto" class="md-none"></div>
                <div class="header-part-right">
                    <!-- Grid menu Dropdown -->
                    <div class="dropdown welcome">
                        Welcome, {{ Auth::user()->name }}
                    </div>
                    <div class="dropdown verification">
                        <a href="{{url('/verify/instant_verification')}}">
                            <button class="btn btn-info" style="">
                                <i class="fa fa-file-archive-o"></i>&nbsp; Start a New Verification </button>
                        </a>
                    </div>
                    <div class="carticon">
                        <a href="{{url('/verify/instant_verification')}}">
            ...
            <div class="mobile-header dsk-none">
                <div class="container">
                    <div class="flex top-header">
                        ...
                        <div class="toggle-bar">
                            <i class="fa fa-bars" aria-hidden="true" id="bar-btn"></i>
                        </div>
                    </div>
                    <div class="below-header flex">
                        <div class="left-name">
                            <p>Welcome, {{ Auth::user()->name }}</p>
                        </div>
                        <div class="verification-box">
                            <a href="{{url('/verify/instant_verification')}}"><i class="fa fa-file-archive-o"></i> Start New Verification</a>
                        </div>
                        <div class="dropdown">
                            <div class="user col align-self-end">
                                <img src="{{asset('guest/images/1.jpg')}}" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
