         ...
         <div class="side-content-wrap">
            <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true" style="top:65px">
               <ul class="navigation-left">
                  ...
                  // dd($user);
                   ?>
               @if ($user == 'vendor' || $user =='vendor_user')
                   
              
                  <li class="nav-item {{ request()->is('vendor/home*') ? 'active' : '' }}"><a href="{{ url('/vendor/home') }}" class="nav-item-hold" ><i class="nav-icon i-Home1"></i>Dashboard</a>
                  {{-- <li class="nav-item {{ request()->is('contacts*') ? 'active' : '' }}" ><a href=""  class="nav-item-hold"><i class="nav-icon i-Male" ></i>Contacts</a> --}}
                  {{-- </li> --}}
                   <li class="nav-item {{ request()->is('vendor/sla*') ? 'active' : '' }}"><a class="nav-item-hold" href="{{ url('/vendor/sla') }}"><i class="nav-icon i-check text-muted header-icon"></i>SLA</a>
                  </li>
                   <li class="nav-item {{ request()->is('vendor/task*') ? 'active' : '' }}" ><a href="{{ url('/vendor/task') }}"  class="nav-item-hold"><i class="nav-icon i-Computer-Secure" ></i>Tasks</a>
                  </li>
                  <li class="nav-item {{ request()->is('vendor/users*') ? 'active' : '' }}"><a href="{{ url('/vendor/users') }}" class="nav-item-hold"> <i class="nav-icon i-Add-User"></i>Users</a>
                  </li>
                  {{--<li class="nav-item {{ request()->is('batches*') ? 'active' : '' }}" ><a href=""  class="nav-item-hold"><i class="nav-icon i-Suitcase" ></i>Batches</a>
                  </li>
                  <li class="nav-item {{ request()->is('candidates*') ? 'active' : '' }}"><a href="" class="nav-item-hold" > <i class="nav-icon i-Add-User"></i>Candidates</a>
                  </li>
                  <li class="nav-item {{ request()->is('insuff*') ? 'active' : '' }}" ><a href=""  class="nav-item-hold"><i class="nav-icon i-Flag"></i>Insufficiency</a>
                  </li>
                  <li class="nav-item {{ request()->is('jobs*') ? 'active' : '' }}"><a href="" class="nav-item-hold"> <i class="nav-icon i-Suitcase"></i>Checks</a>
                  </li>

                  <li class="nav-item {{ request()->is('idChecks*') ? 'active' : '' }}" ><a href=""  class="nav-item-hold"><i class="nav-icon i-check" ></i>Verifications</a>
                  </li>
                  <li class="nav-item {{ request()->is('vendor*') ? 'active' : '' }}" ><a href=" "  class="nav-item-hold"><i class="nav-icon i-Male" ></i>Vendors</a>
                  </li>
                  <li class="nav-item {{ request()->is('report_mis*') ? 'active' : '' }}"><a href="" class="nav-item-hold"> <i class="nav-icon i-Computer-Secure"></i>Quality Checks</a>
                  </li>
                  <li class="nav-item {{ request()->is('reports*') ? 'active' : '' }}"><a href="" class="nav-item-hold"> <i class="nav-icon i-Computer-Secure"></i>Reports</a>
                  </li>
                  </li> --}}
                  
                  {{-- <li class="nav-item  {{ request()->is('vendor/roles*') ? 'active' : '' }}"><a href="{{url('vendor/roles')}}" class="nav-item-hold"> <i class="nav-icon i-Computer-Secure"></i>Roles</a> 
                  </li> --}}
                  {{-- <li class="nav-item"><a class="nav-item-hold" href=""><i class="nav-icon i-Computer-Secure"></i>Pricing Plans</a> --}}
                  {{-- </li> --}}
                  <?php $billing = Request::segment(2); ?>
                  <li class="nav-item @if($billing == 'profile' || $billing =='business'  ) active @endif "><a class="nav-item-hold" href="{{ url('/vendor/profile') }}"><i class="nav-icon i-Gear text-muted header-icon"></i>Accounts</a>
                  </li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" data-id="" data-url="" class="btn btn-primary downloadReportBtn">Download Now</button>
                </div>
            </div>
        </div>
    </div>
