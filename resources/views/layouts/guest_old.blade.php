               ...
               <div class="dropdown">
                  <div class="user col align-self-end">
                     ...
                     <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="{{ route('/guest/settings/profile') }}">Profile</a>
         ...
         <div class="side-content-wrap">
            <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true" style="top:65px">
               ...
               @if ($user == 'guest')
                  ...
                  <li class="nav-item {{ request()->is('guest/home') ? 'active' : '' }}"><a href="{{ url('/guest/home') }}" class="nav-item-hold" ><i class="nav-icon i-Home1"></i>Dashboard</a>
                  ...
                  <li class="nav-item {{ request()->is('guest/candidates*') ? 'active' : '' }}"><a href="{{ url('/guest/candidates') }}" class="nav-item-hold" > <i class="nav-icon i-Add-User"></i>Candidates</a>
                  </li>

                  <li class="nav-item {{ request()->is('guest/orders*') ? 'active' : '' }}"><a href="{{ url('/guest/orders') }}" class="nav-item-hold" > <i class="nav-icon i-check header-icon"></i>Orders</a>
                  </li>
                  {{-- <li class="nav-item"><a class="nav-item-hold" href="{{route('/price_plan')}}"><i class="nav-icon i-Computer-Secure"></i>Pricing Plans</a> --}}
                  {{-- </li> --}}
                  {{-- <li class="nav-item  "><a class="nav-item-hold" href="{{  url('/guest/profile') }}"><i class="nav-icon i-Gear text-muted header-icon"></i>Accounts</a>
                  </li> --}}
