             ...
             <div class="col-md-11 card">
                <div class="card-body">  
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-4">
                             <h4 class="card-title mb-1">Reports  Details</h4> 
                         ...
                         <div id="candidatesResult">
                             @include('guest.reports.checkdetails.details_ajax')   
                         </div> 
                         <!--  -->
                    </div>
              </div>
    ...
    $(document).on('click','.detailBtn',function(){
        ...
        $.ajax({
            ...
            else
            {
                ...
                {
                    $('.modal-footer').html(`<button type="submit" class="btn btn-info order-submit btn-com doc-btn-submit">Submit </button>
