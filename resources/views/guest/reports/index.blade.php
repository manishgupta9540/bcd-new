        ...
        <div class="row">
            ...
            <div class="col-md-8 col-4">           
                <div class="btn-group" style="float:right">
                    @if(count($items)>0)     
                        <a href="#" class="filter0search m-bt-0"><i class="fa fa-filter"></i></a>   
                    @endif              
...
$(document).ready(function(){
    ...
    $(document).on('click','.resndreport',function(){
        var _this = $(this);
        var reports_id = $(this).attr('data-id');
       ...
       // alert(reports_id);
        $.ajax({
               type: 'GET', 
               url:"{{ url('/verify/instantverification/resendreport') }}",
               data: {'reports_id':reports_id},  
               success: function (response) {
               if(response.success==true) {  
                    _this.html('Resend Report');
                     toastr.success("Report resent on your registered mail id");
               }
