      ...
      <div class="row">
         <div class="col-sm-11 col-10">
             <ul class="breadcrumb">
                ...
                <li><a href="{{url('/verify/instant_verification/services',['id'=>Crypt::encryptString($guest_master->id)])}}">Details</a></li>
                <li>Checkout</li>
             </ul>
         </div>
         <!-- ============Back Button ============= -->
      ...
      <div class="row">
         <div class="card text-left">
            <div class="card-body">
               ...
               <hr class="w-25 text-center hr-rspons">
               @if($guest_master!=NULL)
                  <form method="post" id="verificationForm" action="{{ url('/verify/instant_verification/checkout/store') }}" enctype="multipart/form-data">
                     ...
                     <div class="row cartone">
                        <div class="col-md-5 order-md-2 mb-4 col-12 col-sm-5">
                        ...
                        <div class="col-md-7 order-md-1 col-12 col-sm-7">
                           <h4 class="d-flex justify-content-between mb-3">
                              <span class="text-muted">Summary</span>
