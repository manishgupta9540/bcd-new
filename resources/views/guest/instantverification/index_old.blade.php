            ...
            <div class="card-body verify">
               ...
               <div class="row pt-4">
                   <div class="col-md-3 col-3">
                    <h4 class="pl-4 p-0 mb-text-left"><strong>Check Name</strong></h4>
                   </div>
                   <div class="col-md-3 col-3">
                    <h4 class="text-right mb-text-left"><strong>No. Of Verification</strong></h4>
                   </div>
                   <div class="col-md-3 col-3">
                    <h4 class="text-right mb-text-left"><strong>Sample Report</strong></h4>
                   </div>
                   <div class="col-md-3 col-3">
                    <h4 class="text-center mb-text-left"><strong>Price</strong></h4>
                   </div>
               </div>
