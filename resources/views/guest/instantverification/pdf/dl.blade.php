  ...
  <table cellpadding="0" cellspacing="1" class="" style="border-bottom: 1px solid rgb(145, 139, 139)">
     <tr>
        <td colspan="" width="30%" style="text-align:left">
          <img style='height:45px; object-fit:contain; width:150px;' src="{{url('/').'/admin/images/BCD-Logo3.png'}}" alt='BCD'>
        </td>
    ...
    <tr>
      ...
      <tr>
        <td colspan="4" style=" padding: 5px; text-align:center ">
          <h3 style="text-align: center; font-weight:400; font-size:18px; color:#333; "><b>ID Verification</b> </h3>
        </td>
      </tr>
      <tr>
    ...
    <!--  -->
      <tr>
        <td colspan="2" style="padding: 5px; text-align:center ">
          <h3 style="text-align: center; font-weight:400;  font-size:18px; color:#333; "><b>DL Verification </b></h3>
        </td>
      </tr>
        <tr> 
          <td width="50%" style="padding:7px; border: 1px solid #666; ">DL Validity</td> 
        ...
        <tr> <td style="padding:7px; border: 1px solid #666; ">DL Number</td> 
          <td  class="voter_number" style="padding:7px; border: 1px solid #666; "><b> {{ $master_data->dl_number}}</b></td> 
        </tr>
        
         <tr> <td style="padding:7px; border: 1px solid #666; ">Name</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $master_data->name}} </strong></td> 
         </tr>
         ...
         <tr> <td style="padding:7px; border: 1px solid #666; ">DOB</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $master_data->dob!=NULL?date('d-m-Y', strtotime($master_data->dob)):'N/A'}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Spouse Name</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $master_data->father_or_husband_name}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Address</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $master_data->permanent_address}} </strong></td> 
         </tr>
         ...
         <tr> <td style="padding:7px; border: 1px solid #666; ">Country</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $master_data->citizenship}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">DTO</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $master_data->ola_name}} </strong></td> 
         </tr>
         <tr> <td style="padding:7px; border: 1px solid #666; ">Date Of Expire</td> 
          <td class='aadhar_check' style="padding:7px; border: 1px solid #666; "><strong> {{ $master_data->doe!=NULL?date('d-m-Y', strtotime($master_data->doe)):'N/A'}} </strong></td> 
         </tr>
      </tr>
      <!--  -->
    </table>
