    ...
    <!--  -->
      <tr>
        <td colspan="2" style="padding: 5; text-align:center ">
          <h3 style="text-align: center; font-weight:400;  padding: 5px; font-size:18px; color:#333; "><b>Bank Account Verification </b></h3>
        </td>
      </tr>
      
        <tr> <td style="padding:7px; border:1px solid #666; ">Bank Account Validity</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; ">Invalid <img style='width:30px; margin-bottom:-10px;' src="{{ asset('admin/images/check-cancel_50x50.png') }}" alt=""></td> 
        </tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">Bank Account Number</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{ $account_number }} </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">IFSC Code</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> {{ $ifsc_code }} </strong></td> 
        </tr>
