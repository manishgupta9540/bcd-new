    ...
    <!--  -->
      <tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">DOB</td> 
              <td class='' style="padding:7px; border:1px solid #666; "><strong> {{ date('d-m-Y', strtotime($dob)) }} </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">File No.</td> 
             <td class='' style="padding:7px; border:1px solid #666; "><strong> {{ $file_number }} </strong></td> 
        </tr>
