  ...
  <div class="cover" >
    ...
    <table width="100%" cellpadding="0" cellspacing="0" class="main" >
      ...
      <tr> <td width="50%" style="padding:7px; border:1px solid #666; ">Aadhar number</td> 
        <td width="50%" class="aadhar_number" style="padding:7px; border:1px solid #666;"><strong> 986018562300 </strong></td>
      </tr>
      ...
      <tr> <td style="padding:7px; border:1px solid #666; "> Result</td> 
         ...
         <td class='aadhar_check' style="padding:7px; border:1px solid #666; vertical-align:middle;">  <span style="margin-top:-2px;"> <strong > 986018562341 </strong> </span> </td> 
      </tr>
      </tr>
         <tr> <td style="padding:7px; border:1px solid #666; ">Age Bond </td> 
         <td class='aadhar_check' style="padding:7px; border:1px solid #666; "><strong> 20-30 </strong></td> 
      </tr>
      </tr>
         ...
         <td class='aadhar_check' style="padding:7px; border:1px solid #666; "><strong> Delhi </strong></td> 
      </tr>
      </tr>
         <tr> <td style="padding:7px; border:1px solid #666; ">Mobile </td> 
         <td class='aadhar_check' style="padding:7px; border:1px solid #666; ">XXXXXXX<span class="aadhar_mobile"><strong>26</strong></td> 
      </tr>
      <!--  -->
    </table>
