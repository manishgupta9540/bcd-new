    ...
    <!--  -->
      <tr>
        ...
        <tr> <td style="padding:7px; border:1px solid #666; ">Pan Number</td> 
         <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> TPRPS3123Q </strong></td> 
        </tr>
        <tr> <td style="padding:7px; border:1px solid #666; ">Name</td> 
            <td class='aadhar_validity' style="padding:7px; border:1px solid #666; "><strong> RAVI BISHT </strong></td> 
        </tr>
