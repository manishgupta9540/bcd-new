...
class JafFilled implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Mail::send(['html'=>'mails.jaf-filled'], $data, function($message) use($email,$name, $candidate_name,$reference_number,$frnid) {
            $message->to($email, $name)->subject
                ('myBCD System - JAF Notification');
                ($frnid. '' .$candidate_name. '-' .$reference_number.'-JAF Notification');
