...
class BillMonthlyCOC extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'billmonthlycoc:update';
     ...
     * @var string
     */
    protected $description = 'Sends a monthly record for COC on last day of month to calculate price';
    ...
    public function customers_list()
    {
        ...
        foreach($customers as $cust)
        {
            ...
            ->where(['u.user_type'=>'client','u.parent_id'=>$business_id,'b.billing_cycle_period'=>'monthly'])
