...
class JafaddressExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithMapping
{
    use Exportable;
    ...
    */
    ...
    public function collection()
    {
        $query = DB::table('candidate_reinitiates as u')
              ...
              ->where(['u.user_type'=>'candidate','u.parent_id'=>$this->business_id,'jf.service_id'=>'1'])->whereNotNull('form_data');
